...
import { debug, error, log } from "./scripts/lib/lib.js";
import { initHooks, readyHooks, setupHooks } from "./scripts/module.js";
import API from "./scripts/api.js";
import { filterStatusButtons, findAllStatusEffectButtons, findEffectsButton, findStatusEffectButtonsContainingSearchTerm, isPF2E } from "./scripts/effects/effect-quick-status.js";
/* ------------------------------------ */
/* Initialize module					*/
/* ------------------------------------ */
...
Hooks.once("canvasReady", async () => {
    if (game.settings.get(CONSTANTS.MODULE_NAME, "enableQuickStatusEffect")) {
        ...
        Hooks.on("renderTokenHUD", async (app, html, token) => {
            ...
            const qssQuickInput = $(document).find(".active-effect-manager-lib-quick-input, .active-effect-manager-lib-quick-input-pf2e");
