...
export default class Effect {
    ...
    constructor({ customId = "", name = "", label = "", description = "", icon = "icons/svg/aura.svg", tint = "", seconds = NaN, rounds = NaN, turns = NaN, isDynamic = false, isViewable = true, isDisabled = false, // ADDED FROM 4535992
    isTemporary = false, // ADDED FROM 4535992
    isSuppressed = false, // ADDED FROM 4535992
    flags = {}, changes = [], atlChanges = [], tokenMagicChanges = [], nestedEffects = [], subEffects = [], 
    // ADDED FROM 4535992
    transfer = false, atcvChanges = [], dae = {}, overlay = false
    // END ADDED FROM 4535992
     }) {
