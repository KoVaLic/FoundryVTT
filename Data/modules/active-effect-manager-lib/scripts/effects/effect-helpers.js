...
export function createActiveEffect({ label, description = "", icon = "icons/svg/aura.svg", duration = {}, seconds = null, rounds = null, turns = null, isDynamic = false, isViewable = true, flags = {}, origin = null, changes = [], atlChanges = [], tokenMagicChanges = [], nestedEffects = [], subEffects = [] }) {
