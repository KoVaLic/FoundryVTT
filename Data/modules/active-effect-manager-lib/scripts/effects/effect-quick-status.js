...
export function findEffectsButton() {
    return $('[data-action="effects"]');
}
export function findAllStatusEffectButtons() {
    if (isPF2E()) {
        return $(`div.effect-container, div.pf2e-effect-img-container`);
    }
    return $(`div.effect-container, img.effect-control`);
}
export function findStatusEffectButtonsContainingSearchTerm(allButtons, searchTerm) {
