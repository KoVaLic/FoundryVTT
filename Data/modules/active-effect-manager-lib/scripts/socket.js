...
import { setSocket } from "../active-effect-manager-lib.js";
...
export function registerSocket() {
    ...
    // Actor
    activeEffectManagerSocket.register("toggleEffectFromIdOnActor", (...args) => API.toggleEffectFromIdOnActorArr(...args));
    activeEffectManagerSocket.register("hasEffectAppliedOnActor", (...args) => API.hasEffectAppliedOnActorArr(...args));
    activeEffectManagerSocket.register("hasEffectAppliedFromIdOnActor", (...args) => API.hasEffectAppliedFromIdOnActorArr(...args));
    ...
    activeEffectManagerSocket.register("removeEffectFromIdOnActor", (...args) => API.removeEffectFromIdOnActorArr(...args));
    ...
    // Token
    activeEffectManagerSocket.register("toggleEffectFromIdOnToken", (...args) => API.toggleEffectFromIdOnTokenArr(...args));
    activeEffectManagerSocket.register("toggleEffectFromDataOnToken", (...args) => API.toggleEffectFromDataOnTokenArr(...args));
    activeEffectManagerSocket.register("hasEffectAppliedFromIdOnToken", (...args) => API.hasEffectAppliedFromIdOnTokenArr(...args));
    ...
    activeEffectManagerSocket.register("removeEffectFromIdOnToken", (...args) => API.removeEffectFromIdOnTokenArr(...args));
    activeEffectManagerSocket.register("removeEffectFromIdOnTokenMultiple", (...args) => API.removeEffectFromIdOnTokenMultipleArr(...args));
    ...
    activeEffectManagerSocket.register("updateEffectFromIdOnToken", (...args) => API.updateEffectFromIdOnTokenArr(...args));
    activeEffectManagerSocket.register("updateEffectFromNameOnToken", (...args) => API.updateEffectFromNameOnTokenArr(...args));
    activeEffectManagerSocket.register("updateActiveEffectFromIdOnToken", (...args) => API.updateActiveEffectFromIdOnTokenArr(...args));
    activeEffectManagerSocket.register("updateActiveEffectFromNameOnToken", (...args) => API.updateActiveEffectFromNameOnTokenArr(...args));
    // ON MANAGE
    activeEffectManagerSocket.register("onManageActiveEffectFromEffectId", (...args) => API.onManageActiveEffectFromEffectIdArr(...args));
    activeEffectManagerSocket.register("onManageActiveEffectFromEffect", (...args) => API.onManageActiveEffectFromEffectArr(...args));
    activeEffectManagerSocket.register("onManageActiveEffectFromActiveEffect", (...args) => API.onManageActiveEffectFromActiveEffectArr(...args));
